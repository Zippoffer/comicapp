...
app.factory("SearchDatabaseFactory", function($routeParams, $q, $http, LoginRegisterFactory) { //the $q injects an Angular promise
    ...
    let comicList = (searchText) => {
        return $q(function(resolve, reject) {
            ...
            $http.get(`http://gateway.marvel.com:80/v1/public/comics?titleStartsWith=${searchText}&=json&apikey=bf48bed3cb9a213603c0267fe6b78a65`) //the asterix allows for non-specific search
